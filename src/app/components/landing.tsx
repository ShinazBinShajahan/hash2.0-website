...
const Hyperspeed = ({
  ...
  useEffect(() => {
    ...
    function resizeRendererToDisplaySize(renderer: { domElement: any; }, setSize: { (width: any, height: any, updateStyles: any): void; (arg0: any, arg1: any, arg2: boolean): void; }) {
          ...
          <div className="w-full p-5 max-w-[90%] xl:max-w-[1200px] mx-auto">
            ...
            {/* <div className="mb-6">
              <h1 className="text-shadow">
                <span className="text-4xl sm:text-6xl lg:text-7xl font-bold text-red-600">
                  #HASH
                </span>
                <span className="text-3xl sm:text-5xl lg:text-6xl font-bold text-white mt-1">
                  2.0
                </span>
              </h1>
            </div> */}
