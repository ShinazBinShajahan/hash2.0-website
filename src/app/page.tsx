...
const Hyperspeed = ({ effectOptions = {
  ...
  return (<>
    <div id="lights" className="flex items-center justify-center" ref={hyperspeed}>
    <div className="absolute z-10 flex flex-col justify-end min-h-[65vh] px-4 sm:px-6 lg:px-8 backdrop-blur-[2px] backdrop-saturate-[100%] bg-[rgba(31,32,34,0.5)] rounded-[26px] ">
        <div className="w-full max-w-[90%] xl:max-w-[1200px] mx-auto">
          {/* Title Section */}
          <div className="mb-6">
            <h1 className="text-shadow">
              <span className="text-4xl sm:text-6xl lg:text-7xl font-bold text-red-600">#HASH</span>
              <span className="text-3xl sm:text-5xl lg:text-6xl font-bold text-white mt-1">2.0</span>
            </h1>
          </div>
          ...
          <div className="space-y-2 mb-4 text-gray-200">
            ...
            <div className="flex items-center">
              ...
              <span className="text-sm">Mar Baselios Christian College of Engineering and Technology</span>
            </div>
          </div>
          
          {/* Description */}
          <p className="text-sm sm:text-base lg:text-lg text-gray-200 mb-6 text-shadow leading-relaxed max-w-2xl">
            Experience the future of technology at the ultimate techno-cultural fest of <b>Computer Science and Engineering Department</b> where AI, robotics, and innovation converge.
          </p>
          ...
          <div className="flex flex-wrap gap-2 mb-12">
            <span className="text-xs px-2.5 py-1 bg-black/50 backdrop-blur-sm rounded border border-white/20 text-gray-300">Techno-Cultural Events</span>
            <span className="text-xs px-2.5 py-1 bg-black/50 backdrop-blur-sm rounded border border-white/20 text-gray-300">Robotics Expo</span>
            <span className="text-xs px-2.5 py-1 bg-black/50 backdrop-blur-sm rounded border border-white/20 text-gray-300">Online & Offline Events</span>
            <span className="text-xs px-2.5 py-1 bg-black/50 backdrop-blur-sm rounded border border-white/20 text-gray-300">Pro-Show</span>
          </div>
        </div>
      </div>
    </div>
